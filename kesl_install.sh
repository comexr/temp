...
then
    ...
    if [[ ${selected_version} == "testing" ]]; then get_versions $os_name $selected_version
        ...
        if [[ $? -ne 0 ]]; then
            ...
            wget https://products.s.kaspersky-labs.com/endpoints/keslinux10/11.3.0.7441/multilanguage-11.3.0.7441/3635353133317c44454c7c31/kesl-11.3.0-7441.x86_64.rpm && echo "Downloaded kesl" || (echo "Something went wrong, please try again"; exit 1)
            wget https://products.s.kaspersky-labs.com/endpoints/keslinux10/11.3.0.7441/multilanguage-11.3.0.7441/3635353133317c44454c7c31/kesl-11.3.0-7441.x86_64.rpm && echo "Downloaded kesl-gui" || (echo "Something went wrong, please try again"; exit 1)
        else
...
then
    if [[ ${selected_version} == "testing" ]]; then get_versions $os_name $selected_version
        ...
        if [[ $? -ne 0 ]]; then
            #Download files from Kaspersky site
            wget https://products.s.kaspersky-labs.com/endpoints/keslinux10/11.3.0.7441/multilanguage-11.3.0.7441/3635353133317c44454c7c31/kesl-11.3.0-7441.x86_64.rpm && echo "Downloaded kesl" || (echo "Something went wrong, please try again"; exit 1)
            wget https://products.s.kaspersky-labs.com/endpoints/keslinux10/11.3.0.7441/multilanguage-11.3.0.7441/3635353133357c44454c7c31/kesl-gui-11.3.0-7441.x86_64.rpm && echo "Downloaded kesl-gui" || (echo "Something went wrong, please try again"; exit 1)
        else
            echo "Packages already downloaded, skipping"
        fi
        get_versions $os_name $selected_version
...
#Debian/Ubuntu
    ...
    #Download files from Kaspersky site
        ...
        cat *.deb &>/dev/null
        if [[ $? -ne 0 ]]; then
            wget https://products.s.kaspersky-labs.com/endpoints/keslinux10/11.3.0.7441/multilanguage-11.3.0.7441/3635353133397c44454c7c31/kesl_11.3.0-7441_amd64.deb && echo "Downloaded kesl_amd64.deb" || (echo "Something went wrong, please try again"; exit 1)
            wget https://products.s.kaspersky-labs.com/endpoints/keslinux10/11.3.0.7441/multilanguage-11.3.0.7441/3635353133367c44454c7c31/kesl-gui_11.3.0-7441_amd64.deb && echo "Downloaded kesl-gui_amd64.deb" || (echo "Something went wrong, please try again"; exit 1)
        else
            echo "Packages already downloaded, skipping"
        fi
        get_versions $os_name $selected_version
